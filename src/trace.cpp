	...
	Scene<4, 6, 1> scene(
		{
			...
			Object<Sphere>{new Sphere(Vector(-1.75,-1.95,-3.1), 0.6), Vector(4,4,12), zero, Material::Type::diffuse}, // Diffuse sphere
			Object<Sphere>{new Sphere(Vector(-1.12,-2.3,-3.5), 0.2f), Vector(100,200,100), light2, Material::Type::specular}, // Small ball light
		},
		{
			Object<Plane>{new Plane(Y, 2.5), Vector(6,6,6), zero, Material::Type::diffuse}, // Bottom plane
			Object<Plane>{new Plane(Z, 5.5), Vector(6,6,6), zero, Material::Type::diffuse}, // Back plane
			Object<Plane>{new Plane(X, 2.75), Vector(10,2,2), zero, Material::Type::diffuse}, // Left plane
			Object<Plane>{new Plane(-X, 2.75), Vector(2,10,2), zero, Material::Type::diffuse}, // Right plane
			Object<Plane>{new Plane(-Y, 3.0), Vector(6,6,6), zero, Material::Type::diffuse}, // Ceiling plane
			Object<Plane>{new Plane(-Z, 0.5), Vector(6,6,6), zero, Material::Type::diffuse}, // Front plane
		},
		{
			Object<Disc>{new Disc(-Y, Vector(0, 2.9999, -4), 0.7), Vector(0,0,0), light1, Material::Type::diffuse}, // Ceiling light
		}
	);
